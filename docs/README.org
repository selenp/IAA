...
* <2018-05-16 Wed>
 http://39.106.104.75:3022/#/io/main
...
* API
 ...
 提交取还
#+BEGIN_SRC sh
POST http://39.106.104.75:3050/equipment/
...
#+END_SRC
 ...
 取还列表
#+BEGIN_SRC sh
GET http://39.106.104.75:3050/equipment/?eid=1
#+END_SRC

 - GET /equipment/xlsx
 excle下载
#+BEGIN_SRC sh
GET http://39.106.104.75:3050/equipment/xlsx
# http://39.106.104.75:3022/images/poi-generated-file.xlsx
#+END_SRC

 - GET /equipment/currentUser
#+BEGIN_SRC sh
GET http://39.106.104.75:3050/equipment/currentUser
# http://39.106.104.75:3022/images/poi-generated-file.xlsx
#+END_SRC

 - POST /equipment/currentUser
#+BEGIN_SRC sh
Content-Type: application/json
POST http://39.106.104.75:3050/equipment/api-login-account
# http://39.106.104.75:3022/images/poi-generated-file.xlsx
#+END_SRC
...
数据字典
#+BEGIN_SRC sh
GET http://39.106.104.75:3050/equipment/dictionary
#+END_SRC
...
#+RESULTS:
 ...
 某一次取还
#+BEGIN_SRC sh
GET http://39.106.104.75:3050/equipment/65
#+END_SRC

 - POST /equipment/signature
 上载签名图片
#+BEGIN_SRC sh
POST http://39.106.104.75:3050/equipment/4/borrow/signature
Content-Type: application/json
...
#+END_SRC
#+BEGIN_SRC sh
POST http://39.106.104.75:3050/equipment/4/return/signature
Content-Type: application/json
