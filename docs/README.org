...
*** NEXT 图片压缩到 200k左右
** 消息模块
*** TODO 库管发布消息， 指定角色，在dashboard上显示
** 用户管理
*** DONE 角色查询：su， am， it
...
Authorization: Bearer BX+t3Tbf5hqSYlgqxda/TZpTOK4F9yerd14tVqO0caI=
#+END_SRC
...
#+END_SRC
   ...
   excle下载
#+BEGIN_SRC sh
GET http://localhost:3050/delivery/?xlsx=true
...
#+END_SRC
   ...
   取还列表
#+BEGIN_SRC sh
GET http://localhost:3050/task/?eid=1
#GET http://localhost:3050/task/
#+END_SRC

   - GET /task/xlsx
   excle下载
#+BEGIN_SRC sh
GET http://localhost:3050/task/?xlsx=true
# http://localhost:3022/images/poi-generated-file.xlsx
#+END_SRC
   ...
   某一次取还
#+BEGIN_SRC sh
GET http://localhost:3050/task/1
#+END_SRC
...
** Transfer
   ...
   提交取还
#+BEGIN_SRC sh
POST http://localhost:3050/transfer-event/
Content-Type: application/json
...
#+END_SRC
   ...
   取还列表
#+BEGIN_SRC sh
GET http://localhost:3050/transfer-event/?eid=1
#GET http://localhost:3050/transfer-event/
#+END_SRC

   - GET /transfer-event/xlsx
   excle下载
#+BEGIN_SRC sh
GET http://localhost:3050/transfer-event/?xlsx=true
# http://localhost:3022/images/poi-generated-file.xlsx
#+END_SRC
   ...
   某一次取还
#+BEGIN_SRC sh
GET http://localhost:3050/transfer-event/65
#+END_SRC

   - POST /transfer-event/signature
   上载签名图片
#+BEGIN_SRC sh
POST http://localhost:3050/transfer-event/4/borrow/signature
Content-Type: application/json

data:image/png;base64,
#+END_SRC
#+BEGIN_SRC sh
POST http://localhost:3050/transfer-event/4/return/signature
Content-Type: application/json
...
** Dictionary
   - 数据字典
#+BEGIN_SRC sh
GET http://localhost:3050/dictionary/_all
#+END_SRC
   - List
#+BEGIN_SRC sh
...
#+END_SRC
   ...
   - 删除一个
#+BEGIN_SRC sh
DELETE http://localhost:3050/dictionary/5
#+END_SRC

* Deployment
** 同步
#+BEGIN_SRC sh
gradle build && java -Dspring.profiles.active=development -jar build/libs/gs-accessing-data-h2-0.1.0605.jar
