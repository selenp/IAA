...
** 遗留问题
*** TODO 需要把java应用变成windows服务，要不然windows的session没了，java就停了
...
gradle build && java -jar build/libs/gs-accessing-data-h2-0.1.0608.jar
#+END_SRC
...
gradle build
scp build/libs/gs-accessing-data-h2-0.1.0608.jar  yidalize_no1:/usr/share/nginx/html/yida-lize-file/
java -jar build/libs/gs-accessing-data-h2-0.1.0608.jar
