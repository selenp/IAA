...
* 页面流程
  http://39.106.104.75:3022/#/delivery/main
...
POST http://39.106.104.75:3050/account/api-login-account
Content-Type: application/json
...
"password": "zhaoleipass"
   ...
   - currentUser
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/account/currentUser
Authorization: Bearer SgxwdORcnzpCjfZ3eLqMwAQf7Qsc0w204bhWehIobvI=
   #+END_SRC

** Admin
   - add
   #+BEGIN_SRC sh
POST http://39.106.104.75:3050/admin/
Content-Type: application/json
...
"password": "zhaoleipass",
"fullname": "ZhaoLei",
"roles": "assert manager,super_admin",
"avatar": "https://gw.alipayobjects.com/zos/rmsportal/gaOngJwsRYRaVAuXXcmB.png"
   ...
   - list
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/admin/
   #+END_SRC
...
** Delivery
   ...
   提交取还
   #+BEGIN_SRC sh
POST http://39.106.104.75:3050/delivery/
Content-Type: application/json
...
"progress": "borrow"
   ...
   取还列表
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/delivery/?eid=1
#GET http://39.106.104.75:3050/delivery/
   #+END_SRC

   - GET /delivery/xlsx
   excle下载
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/delivery/?xlsx=true
# http://39.106.104.75:3022/images/poi-generated-file.xlsx
   #+END_SRC

   - GET /delivery//:id
   某一次取还
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/delivery/65
   #+END_SRC

   - POST /delivery/signature
   上载签名图片
   #+BEGIN_SRC sh
POST http://39.106.104.75:3050/delivery/4/borrow/signature
Content-Type: application/json
...
data:image/png;base64,
   #+END_SRC
   #+BEGIN_SRC sh
POST http://39.106.104.75:3050/delivery/4/return/signature
Content-Type: application/json
...
** Task
   ...
   提交取还
   #+BEGIN_SRC sh
POST http://39.106.104.75:3050/task/
Content-Type: application/json
...
"assignToRole": "assert manager"
   ...
   取还列表
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/task/?eid=1
#GET http://39.106.104.75:3050/task/
   #+END_SRC

   - GET /task/xlsx
   excle下载
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/task/?xlsx=true
# http://39.106.104.75:3022/images/poi-generated-file.xlsx
   #+END_SRC
   ...
   某一次取还
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/task/1
   #+END_SRC
...
** Transfer
   ...
   提交取还
   #+BEGIN_SRC sh
POST http://39.106.104.75:3050/transfer-event/
Content-Type: application/json
...
"ownerEid": "200"
   ...
   取还列表
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/transfer-event/?eid=1
#GET http://39.106.104.75:3050/transfer-event/
   #+END_SRC

   - GET /transfer-event/xlsx
   excle下载
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/transfer-event/?xlsx=true
# http://39.106.104.75:3022/images/poi-generated-file.xlsx
   #+END_SRC
   ...
   某一次取还
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/transfer-event/65
   #+END_SRC

   - POST /transfer-event/signature
   上载签名图片
   #+BEGIN_SRC sh
POST http://39.106.104.75:3050/transfer-event/4/borrow/signature
Content-Type: application/json

data:image/png;base64,
   #+END_SRC
   #+BEGIN_SRC sh
POST http://39.106.104.75:3050/transfer-event/4/return/signature
Content-Type: application/json
...
** Dictionary
   - 数据字典
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/dictionary/_all
   #+END_SRC
   - List
   #+BEGIN_SRC sh
GET http://39.106.104.75:3050/dictionary/
   #+END_SRC

   - 删除一个
   #+BEGIN_SRC sh
DELETE http://39.106.104.75:3050/dictionary/5
   #+END_SRC
...
** 同步
   #+BEGIN_SRC sh
gradle build
scp build/libs/gs-accessing-data-h2-0.1.0528.jar  yidalize_no1:/usr/share/nginx/html/yida-lize-file/
java -jar build/libs/gs-accessing-data-h2-0.1.0528.jar
