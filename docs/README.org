...
*** DONE 签名的layout修改
    ...
    :END:
*** DONE 图片命名 sn-yyyy-mm-dd，并且用YYY-MM细分文件夹
...
*** NEXT 图片压缩到 200k左右
    :LOGBOOK:
    - State "NEXT"       from "DONE"       [2018-06-07 Thu 21:02]
    - State "DONE"       from "NEXT"       [2018-06-07 Thu 21:02]
    :END:
** 消息模块
...
"password": "zhaoleipass",
"fullname": "ZhaoLei",
"roles": "asset manager,super_admin,it staff",
...
gradle build && java -jar build/libs/gs-accessing-data-h2-0.1.0605.jar
#+END_SRC
...
gradle build
scp build/libs/gs-accessing-data-h2-0.1.0605.jar  yidalize_no1:/usr/share/nginx/html/yida-lize-file/
java -jar build/libs/gs-accessing-data-h2-0.1.0605.jar
